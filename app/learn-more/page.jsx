...
return (
      ...
      {/* Header */}
        <header className="w-full flex justify-center">
            ...
            <img
                ...
                loading="lazy"/>
            <div>
                <span className="text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-cyan-300 via-cyan-500 to-cyan-700 text-transparent bg-clip-text">
                    QuickVid AI
                </span>
                <div className="text-white/80 text-base mt-1 font-semibold tracking-wide">
                    Unleash AI magic. Turn any idea into a video story.
                </div>
            </div>
        </div>
        </header>
        ...
        <Card className="max-w-4xl w-full border border-white/10 bg-white/5 backdrop-blur-md rounded-3xl shadow-xl">
            ...
            {/* Future Scopes */}
            <section>
                <h2 className="text-2xl font-bold mb-4 text-cyan-400">🚀 Future Scopes</h2>
                <ul className="list-disc pl-6 space-y-2 text-white/80">
            ...
            {/* About Authors */}
            <section>
                <h2 className="text-2xl font-bold mb-4 text-cyan-400">👋 About the Authors</h2>
            ...
            <div className="flex justify-center pt-4">
                <Button
                    asChild
                    className="bg-gradient-to-r from-cyan-400 to-cyan-700 px-6 py-3 text-white font-semibold rounded-full shadow-md hover:scale-105 transition-transform"
                >
    ...
    <footer className="mt-12 text-center text-white/70 text-sm border-t border-white/10 pt-6">
        ...
        <a 
            ...
            <span asChild className="text-white/80 font-medium"><a href="https://github.com/AaryanBairagi/QuickVid">GitHub</a></span>
        </a>
        </div>
