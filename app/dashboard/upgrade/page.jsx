...
export default function UpgradePage() {
  ...
  // Fetch current plan/tier from backend
    useEffect(() => {
    ...
    <div className="p-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div
                ...
                bg-white/5 backdrop-blur-md transition-shadow duration-300
                ${
                    isCurrent
                    ? "border-yellow-400 shadow-[0_0_20px_rgba(250,204,21,0.8)] animate-pulse" // 🔥 yellow glow for current plan
                    : plan.popular
